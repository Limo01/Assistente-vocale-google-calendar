/*
 * @brief Classe che gestisce l'avatar, disegna il personaggio e si occupa del movimento della bocca quando deve parlare
 */
function Avatar()
{
...
/*
 * @brief funzione che cambia lo stato della bocca da aperta a chiuse e viceversa 
 */
...
/*
 * @brief metodo che viene chiamato quando l'avatar deve smettere di parlare. Lo riposiziona a bocca chiusa qualora gli sia rimasta aperta
 */
...
/*
 * @brief metodo per far chiuedere gli occhi all'avatar
 */
...
/*
 * @metodo per far aprire gli occhi all'avatar
 */
